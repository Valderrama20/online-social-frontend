...
export default function CreateUserModal({ changeState }) {
  ...
  return (
    <div className="fixed flex h-screen w-screen ">
      <form
        onSubmit={createUser}
        className=" rounded-2xl w-full sm:w-[500px] sm:m-auto text-white p-3 z-50 bg-black "
      >
        ...
        {paso == 1 ? (
          ...
          <div className=" flex flex-col sm:px-16 space-y-2 ">
            <input
              type="text"
              name="username"
